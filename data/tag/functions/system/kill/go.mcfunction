...
# announce
tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"🗡","color":"#FB7C3F"},{"text":"] ","color":"dark_gray"},{"selector":"@s","color":"#FB7C3F"},{"text":" › ","color":"gray"},{"selector":"@a[scores={player.direct_death=1..},limit=1]","color":"#CE3F29"}]
title @s title ""
