...
execute unless score tracking_kill_weapon_items internal matches 1.. if score can_kill_weapon_items internal matches 0 run schedule function tag:system/item/weapon/check 3t
