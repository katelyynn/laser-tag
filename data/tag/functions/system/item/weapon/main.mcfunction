...
execute unless score tracking_kill_weapon_items internal matches 1.. run scoreboard players set can_kill_weapon_items internal 1
## 1: can kill
## 0: cannot kill
...
execute unless score tracking_kill_weapon_items internal matches 1.. if score can_kill_weapon_items internal matches 1.. run scoreboard players set tracking_kill_weapon_items internal 1