...
data modify storage tag:maps page0 append value {Slot:2b, id:"minecraft:carrot_on_a_stick", tag:{page: 0, selection: 2, mapItem: 1b, CustomModelData:101, display:{Name:'{"text":"New WIP","italic":false}',Lore:['{"text":"by DR_Nolife, aztro_, and katehaj","italic":false,"color":"gray"}']}}, Count:1b}
data modify storage tag:maps page0 append value {Slot:3b, id:"minecraft:carrot_on_a_stick", tag:{page: 0, selection: 3, mapItem: 1b, CustomModelData:102, display:{Name:'{"text":"Forest","italic":false}',Lore:['{"text":"by katehaj","italic":false,"color":"gray"}']}}, Count:1b}
data modify storage tag:maps page0 append value {Slot:4b, id:"minecraft:carrot_on_a_stick", tag:{page: 0, selection: 4, mapItem: 1b, CustomModelData:103, display:{Name:'{"text":"Backrooms","italic":false}',Lore:['{"text":"by katehaj and CatgirlEllaa","italic":false,"color":"gray"}']}}, Count:1b}
data modify storage tag:maps page0 append value {Slot:5b, id:"minecraft:carrot_on_a_stick", tag:{page: 0, selection: 5, mapItem: 1b, CustomModelData:104, display:{Name:'{"text":"Pumpkin Patch","italic":false}',Lore:['{"text":"by katehaj and CatgirlEllaa","italic":false,"color":"gray"}']}}, Count:1b}