...
data modify storage tag:maps maps append value {Slot:18b, id:"minecraft:carrot_on_a_stick", tag:{page: 0, selection: 18, mapItem: 1b, CustomModelData:5, display:{Name:'{"text":"Toggle map dev mode","color":"green","italic":false}'}}, Count:1b}
