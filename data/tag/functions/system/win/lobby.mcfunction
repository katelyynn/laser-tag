...
# announce
tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"→","color":"gray"},{"text":"] ","color":"dark_gray"},{"text":"Game over! \u0020 ","color":"gray"},{"text":"[Open profile]","color":"green","clickEvent":{"action":"run_command","value":"/trigger profile"}},"\n"]
# sfx
