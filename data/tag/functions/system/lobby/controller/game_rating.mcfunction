...
execute if score game_rating global matches 0 run data merge entity @s {Item:{tag:{CustomModelData:1}}}
execute if score game_rating global matches 1 run data merge entity @s {Item:{tag:{CustomModelData:2}}}
