...
execute if score @s lobby_controls matches 1.. run tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"→","color":"gray"},{"text":"] ","color":"dark_gray"},{"text":"Game configuration has been reset.","color":"gray"}]
