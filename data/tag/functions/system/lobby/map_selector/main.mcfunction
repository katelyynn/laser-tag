...
execute if score @s temp_store.map_selector matches 0 run function tag:system/lobby/map_selector/page/0/main
#execute if score @s temp_store.map_selector matches 1 run function tag:system/lobby/map_selector/page/1/main
