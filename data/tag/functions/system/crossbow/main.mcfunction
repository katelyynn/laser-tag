...
# coins
## copper
execute if score @s leaderboard.coins matches 0..999 if score @s player.ready matches 1.. if score period internal matches -1 if entity @s[nbt=!{SelectedItem:{id:"minecraft:crossbow",Count:1b,tag:{canReload:1b,weaponItem:1b}}}] run title @s actionbar ["",{"text":"⑪ ","color":"#CC692C"},{"score":{"name":"@s","objective":"leaderboard.coins"},"color":"#CC692C"},{"text":" Coins","color":"#CC692C"},{"text":" \u0020 "},{"text":"Ready","color":"#94FC94"}]
execute if score @s leaderboard.coins matches 0..999 unless score @s player.ready matches 1.. if score period internal matches -1 if entity @s[nbt=!{SelectedItem:{id:"minecraft:crossbow",Count:1b,tag:{canReload:1b,weaponItem:1b}}}] run title @s actionbar ["",{"text":"⑪ ","color":"#CC692C"},{"score":{"name":"@s","objective":"leaderboard.coins"},"color":"#CC692C"},{"text":" Coins","color":"#CC692C"},{"text":" \u0020 "},{"text":"Not ready","color":"#565663"}]
## silver
execute if score @s leaderboard.coins matches 1000..9999 if score @s player.ready matches 1.. if score period internal matches -1 if entity @s[nbt=!{SelectedItem:{id:"minecraft:crossbow",Count:1b,tag:{canReload:1b,weaponItem:1b}}}] run title @s actionbar ["",{"text":"⑫ ","color":"#A8B5B5"},{"score":{"name":"@s","objective":"leaderboard.coins"},"color":"#A8B5B5"},{"text":" Coins","color":"#A8B5B5"},{"text":" \u0020 "},{"text":"Ready","color":"#94FC94"}]
execute if score @s leaderboard.coins matches 1000..9999 unless score @s player.ready matches 1.. if score period internal matches -1 if entity @s[nbt=!{SelectedItem:{id:"minecraft:crossbow",Count:1b,tag:{canReload:1b,weaponItem:1b}}}] run title @s actionbar ["",{"text":"⑫ ","color":"#A8B5B5"},{"score":{"name":"@s","objective":"leaderboard.coins"},"color":"#A8B5B5"},{"text":" Coins","color":"#A8B5B5"},{"text":" \u0020 "},{"text":"Not ready","color":"#565663"}]
## gold
execute if score @s leaderboard.coins matches 10000..99999 if score @s player.ready matches 1.. if score period internal matches -1 if entity @s[nbt=!{SelectedItem:{id:"minecraft:crossbow",Count:1b,tag:{canReload:1b,weaponItem:1b}}}] run title @s actionbar ["",{"text":"⑨ ","color":"#EBD779"},{"score":{"name":"@s","objective":"leaderboard.coins"},"color":"#EBD779"},{"text":" Coins","color":"#EBD779"},{"text":" \u0020 "},{"text":"Ready","color":"#94FC94"}]
execute if score @s leaderboard.coins matches 10000..99999 unless score @s player.ready matches 1.. if score period internal matches -1 if entity @s[nbt=!{SelectedItem:{id:"minecraft:crossbow",Count:1b,tag:{canReload:1b,weaponItem:1b}}}] run title @s actionbar ["",{"text":"⑨ ","color":"#EBD779"},{"score":{"name":"@s","objective":"leaderboard.coins"},"color":"#EBD779"},{"text":" Coins","color":"#EBD779"},{"text":" \u0020 "},{"text":"Not ready","color":"#565663"}]
## platinum
execute if score @s leaderboard.coins matches 100000.. if score @s player.ready matches 1.. if score period internal matches -1 if entity @s[nbt=!{SelectedItem:{id:"minecraft:crossbow",Count:1b,tag:{canReload:1b,weaponItem:1b}}}] run title @s actionbar ["",{"text":"⑬ ","color":"#D6C5E4"},{"score":{"name":"@s","objective":"leaderboard.coins"},"color":"#D6C5E4"},{"text":" Coins","color":"#D6C5E4"},{"text":" \u0020 "},{"text":"Ready","color":"#94FC94"}]
execute if score @s leaderboard.coins matches 100000.. unless score @s player.ready matches 1.. if score period internal matches -1 if entity @s[nbt=!{SelectedItem:{id:"minecraft:crossbow",Count:1b,tag:{canReload:1b,weaponItem:1b}}}] run title @s actionbar ["",{"text":"⑬ ","color":"#D6C5E4"},{"score":{"name":"@s","objective":"leaderboard.coins"},"color":"#D6C5E4"},{"text":" Coins","color":"#D6C5E4"},{"text":" \u0020 "},{"text":"Not ready","color":"#565663"}]