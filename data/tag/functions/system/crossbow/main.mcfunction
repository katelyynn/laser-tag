...
execute if score period internal matches -1 if entity @s[nbt=!{SelectedItem:{id:"minecraft:crossbow",Count:1b,tag:{crossbow_type:"machine"}}},nbt=!{SelectedItem:{id:"minecraft:crossbow",Count:1b,tag:{crossbow_type:"normal"}}},nbt=!{SelectedItem:{id:"minecraft:crossbow",Count:1b,tag:{crossbow_type:"rocket"}}}] run title @s actionbar ["",{"text":"Coins: "},{"score":{"name":"@s","objective":"leaderboard.coins"},"color":"yellow"},{"text":"  ④ "},{"score":{"name":"@s","objective":"leaderboard.wins"},"color":"yellow"},{"text":"  ③ "},{"score":{"name":"@s","objective":"leaderboard.kills"},"color":"yellow"},{"text":"  ⑤ "},{"score":{"name":"@s","objective":"leaderboard.deaths"},"color":"yellow"}]