...
# announce
execute if score @s crossbow_glowing.shots >= crossbow_glowing.ammo internal run title @s[nbt={SelectedItem:{id:"minecraft:crossbow",Count:1b,tag:{crossbow_type:"glowing"}}}] actionbar ["",{"text":"Score: "},{"score":{"name":"@s","objective":"player.score"},"color":"yellow"},{"text":" \u0020 \u0020Ammo: "},{"score":{"objective":"crossbow_glowing.shots_remaining","name":"@s"},"color":"gray","bold":true},{"text":"/","color":"gray"},{"score":{"objective":"internal","name":"crossbow_glowing.ammo"},"color":"gray","bold":true},{"text":" \u0020 \u0020Reloading!"}]
