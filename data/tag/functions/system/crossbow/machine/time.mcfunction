...
# announce
execute if score @s crossbow_machine.shots >= crossbow_machine.ammo internal run title @s[nbt={SelectedItem:{id:"minecraft:crossbow",Count:1b,tag:{crossbow_type:"machine"}}}] actionbar ["",{"text":"Score: "},{"score":{"name":"@s","objective":"player.score"},"color":"yellow"},{"text":" \u0020 \u0020Ammo: "},{"score":{"objective":"crossbow_machine.shots_remaining","name":"@s"},"color":"gray","bold":true},"/",{"score":{"objective":"internal","name":"crossbow_machine.ammo"},"color":"gray","bold":true},{"text":" \u0020 \u0020Reloading!"}]
