...
# announce
execute if score @s crossbow_rocket.shots >= crossbow_rocket.ammo internal run title @s[nbt={SelectedItem:{id:"minecraft:crossbow",Count:1b,tag:{crossbow_type:"rocket"}}}] actionbar ["",{"text":"Score: "},{"score":{"name":"@s","objective":"player.score"},"color":"yellow"},{"text":" \u0020 \u0020Ammo: "},{"score":{"objective":"crossbow_rocket.shots_remaining","name":"@s"},"color":"gray","bold":true},"/",{"score":{"objective":"internal","name":"crossbow_rocket.ammo"},"color":"gray","bold":true},{"text":" \u0020 \u0020Reloading!"}]
