...
## alt action
execute if score map_dev_mode internal matches 1.. if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{map_dev_alt_action:1b}}}] run scoreboard players add @s temp_store.map_dev_player_state 1
