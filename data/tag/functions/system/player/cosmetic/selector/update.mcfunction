...
# reset
execute if score @s temp_store.cosmetic_selector.selection matches 8 unless score @s temp_store.cosmetic_selector.page matches 0 unless score @s temp_store.cosmetic_selector.page matches 70..71 run playsound tag:menu.back player @s ~ ~ ~
execute if score @s temp_store.cosmetic_selector.selection matches 10 unless score @s temp_store.cosmetic_selector.page matches 0 unless score @s temp_store.cosmetic_selector.page matches 70..71 run playsound tag:menu.scroll player @s ~ ~ ~
execute if score @s temp_store.cosmetic_selector.selection matches 17 unless score @s temp_store.cosmetic_selector.page matches 0 unless score @s temp_store.cosmetic_selector.page matches 70..71 run playsound tag:menu.scroll player @s ~ ~ ~
...
# default selections
execute if score @s temp_store.cosmetic_selector.selection matches 8 unless score @s temp_store.cosmetic_selector.page matches 0 unless score @s temp_store.cosmetic_selector.page matches 70..71 run scoreboard players set @s temp_store.cosmetic_selector.page 0
## arrows
execute unless score @s temp_store.cosmetic_selector.page matches 0 unless score @s temp_store.cosmetic_selector.page matches 70..71 if score @s temp_store.cosmetic_selector.selection matches 10 run scoreboard players remove @s temp_store.cosmetic_selector.page 1
execute unless score @s temp_store.cosmetic_selector.page matches 0 unless score @s temp_store.cosmetic_selector.page matches 70..71 if score @s temp_store.cosmetic_selector.selection matches 17 run scoreboard players add @s temp_store.cosmetic_selector.page 1
## range check
