...
# clear chest
item replace entity @s enderchest.0 with carrot_on_a_stick{page: 0, selection: 0, cosmeticItem: 1b, CustomModelData:37, display:{Name:'{"text":"","color":"green","italic":false}'}}
...
item replace entity @s enderchest.18 with carrot_on_a_stick{page: 0, selection: 18, cosmeticItem: 1b, CustomModelData:37, display:{Name:'{"text":"","color":"green","italic":false}'}}
