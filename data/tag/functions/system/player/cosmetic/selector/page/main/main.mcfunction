...
item replace entity @s enderchest.18 with carrot_on_a_stick{page: 0, selection: 8, cosmeticItem: 1b, CustomModelData:7, display:{Name:'{"text":"","color":"green","italic":false}'}}
...
item replace entity @s enderchest.14 with carrot_on_a_stick{page: 0, selection: 14, cosmeticItem: 1b, CustomModelData:490, display:{Name:'{"text":"???","italic":false}',Lore:['{"text":"do something bla bla bla","italic":false,"color":"gray"}']}}