...
execute if entity @s[tag=item_spawner.crossbow_glowing] run scoreboard players operation @s item_spawner.replenish = crossbow_glowing item_spawner.replenish
