give @s bat_spawn_egg{display:{Name:'{"text":"item_spawner.random","italic":false}'},EntityTag:{id:"minecraft:area_effect_cloud",Particle:"block air",Radius:0f,Age:2147483647,Tags:["item_spawner.generic","item_spawner.random"]}} 1
